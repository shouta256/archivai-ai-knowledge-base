...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95 backdrop-blur-md',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_12px_30px_rgba(10,132,255,0.35)] ring-1 ring-white/15',
        destructive: 'bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-[0_12px_30px_rgba(255,69,58,0.3)] ring-1 ring-white/15',
        outline: 'glass-outline text-foreground',
        secondary: 'glass-button text-secondary-foreground',
        ghost: 'glass-outline text-foreground',
